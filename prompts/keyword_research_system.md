...
1. Primary Keywords (main high-volume keywords)
2. Secondary Keywords (related supporting keywords)
3. Long-Tail Keywords (specific, low-competition phrases)
4. Question-Based Keywords (user queries for SEO)
5. Local SEO Keywords (location-specific variations)

Ensure:
- Keywords are relevant to genetic testing services
